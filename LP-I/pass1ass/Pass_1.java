...
public class Pass_1 {
    ...
    public void generateIC() throws Exception {
        ...
        BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\amanp\\OneDrive\\Desktop\\spos\\LP-I\\ps1\\input.asm"));
        String line = " ";
        pooltab.add(0, 0);
        wr.write("---------------------\n  Intermediate Code\n---------------------\n");
        while ((line = br.readLine()) != null) {
            ...
            if (split[1].equals("START")) {
                ...
                if (split.length > 3 && split[3] != null) {
                    ...
                    }else if (split[3].equals("AREG")) {
                        wr.write("(1) \n");
                    } else if (split[3].equals("BREG")) {
                        wr.write("(2) \n");
                    } else if (split[3].equals("CREG")) {
                        wr.write("(3) \n");
                    } else if (split[3].equals("DREG")) {
                        wr.write("(4) \n");
                    } else {
                        symtab.add(split[3]);
                        symaddr.add(0);
